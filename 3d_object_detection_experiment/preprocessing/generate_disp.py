...
#this script creates the disparity map from the two images
#this function takes in the lidar, height, weidth, calib and generate the ground truth disparity
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/zhengjiwang/project/self-defeating/KITTI/object/training/')
    parser.add_argument('--split_file', type=str, default='/home/zhengjiwang/project/self-defeating/KITTI/object/trainval.txt')
    ...
    disparity_dir = args.data_path + '/disparity_val/'
    ...
    # read the train.txt and makes a list
